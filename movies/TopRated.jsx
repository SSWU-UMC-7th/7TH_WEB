...
//           `https://api.themoviedb.org/3/movie/top_rated?api_key=71b31b966fde85da73283ea6b3ccbc60&language=ko-KR&page=1` // 영화 데이터 요청
//         );
...
const TopRated = () => {
  ...
  const { data, error, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await axios.get(
        `https://api.themoviedb.org/3/movie/top_rated?api_key=71b31b966fde85da73283ea6b3ccbc60&language=ko-KR&page=1`
      );
